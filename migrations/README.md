...
Use numbered SQL migrations with matching up/down files. Do not use GORM AutoMigrate
at application startup or rewrite a migration after it has been applied.

The foundation does not create business tables. Agree the schema in the development
plan before adding the first migration and selecting/pinning a migration runner.
